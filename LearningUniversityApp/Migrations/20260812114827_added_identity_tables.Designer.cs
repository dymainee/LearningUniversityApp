...
namespace LearningUniversityApp.Migrations
{
    ...
    [Migration("20260812114827_added_identity_tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningUniversityApp.Models.User", b =>
                {
            ...
            modelBuilder.Entity("LearningUniversityApp.Models.Student", b =>
                {
                    ...
                    b.HasOne("LearningUniversityApp.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("LearningUniversityApp.Models.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LearningUniversityApp.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
